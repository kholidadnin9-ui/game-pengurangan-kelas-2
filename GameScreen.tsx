...
import { Level, Question } from "./levels";
import monkeyPeekImg from "./monkey-peek.png";
import boyCheerImg from "./boy-cheer.png";
...
export default function GameScreen({
  ...
  const praise =
    praisePhrases[
      Math.floor(
        Math.random() * praisePhrases.length
      )
    ];
